...
namespace WebAssignment
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="aspnet-WebAssignment-20161114041541")]
    ...
    partial void InsertSocietyRegistration(SocietyRegistration instance);
    partial void UpdateSocietyRegistration(SocietyRegistration instance);
    partial void DeleteSocietyRegistration(SocietyRegistration instance);
    ...
    partial void InsertClubRegistration(ClubRegistration instance);
    partial void UpdateClubRegistration(ClubRegistration instance);
    partial void DeleteClubRegistration(ClubRegistration instance);
    ...
    partial void DeleteSociety(Society instance);
		...
		public System.Data.Linq.Table<SocietyRegistration> SocietyRegistrations
		{
			get
			{
				return this.GetTable<SocietyRegistration>();
			}
		}
		...
		public System.Data.Linq.Table<ClubRegistration> ClubRegistrations
		{
			get
			{
				return this.GetTable<ClubRegistration>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.SocietyRegistration")]
	public partial class SocietyRegistration : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnisActiveChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SocietyId", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_StudentId", DbType="NVarChar(128) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUser_SocietyRegistration", Storage="_AspNetUser", ThisKey="StudentId", OtherKey="Id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._AspNetUser.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.SocietyRegistrations.Remove(this);
					}
					this._AspNetUser.Entity = value;
					if ((value != null))
					{
						value.SocietyRegistrations.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Society_SocietyRegistration", Storage="_Society", ThisKey="SocietyId", OtherKey="Id", IsForeignKey=true)]
	...
	public partial class AspNetUser : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<SocietyRegistration> _SocietyRegistrations;
		...
		private EntitySet<Club> _Clubs1;
		
		private EntitySet<ClubRegistration> _ClubRegistrations;
		
		private EntitySet<Society> _Societies1;
    ...
    partial void OnSocietiesChanging(string value);
    partial void OnSocietiesChanged();
    partial void OnClubsChanging(string value);
    partial void OnClubsChanged();
    #endregion
		
		public AspNetUser()
		{
			this._SocietyRegistrations = new EntitySet<SocietyRegistration>(new Action<SocietyRegistration>(this.attach_SocietyRegistrations), new Action<SocietyRegistration>(this.detach_SocietyRegistrations));
			this._AspNetUserClaims = new EntitySet<AspNetUserClaim>(new Action<AspNetUserClaim>(this.attach_AspNetUserClaims), new Action<AspNetUserClaim>(this.detach_AspNetUserClaims));
			this._AspNetUserLogins = new EntitySet<AspNetUserLogin>(new Action<AspNetUserLogin>(this.attach_AspNetUserLogins), new Action<AspNetUserLogin>(this.detach_AspNetUserLogins));
			this._AspNetUserRoles = new EntitySet<AspNetUserRole>(new Action<AspNetUserRole>(this.attach_AspNetUserRoles), new Action<AspNetUserRole>(this.detach_AspNetUserRoles));
			this._Clubs1 = new EntitySet<Club>(new Action<Club>(this.attach_Clubs1), new Action<Club>(this.detach_Clubs1));
			this._ClubRegistrations = new EntitySet<ClubRegistration>(new Action<ClubRegistration>(this.attach_ClubRegistrations), new Action<ClubRegistration>(this.detach_ClubRegistrations));
			this._Societies1 = new EntitySet<Society>(new Action<Society>(this.attach_Societies1), new Action<Society>(this.detach_Societies1));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Societies", DbType="NVarChar(MAX)")]
		public string Societies
		{
			...
			set
			{
				if ((this._Societies != value))
				{
					this.OnSocietiesChanging(value);
					this.SendPropertyChanging();
					this._Societies = value;
					this.SendPropertyChanged("Societies");
					this.OnSocietiesChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Clubs", DbType="NVarChar(MAX)")]
		public string Clubs
		{
			get
			{
			...
			set
			{
				...
				{
					this.OnClubsChanging(value);
					this.SendPropertyChanging();
					this._Clubs = value;
					this.SendPropertyChanged("Clubs");
					this.OnClubsChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUser_SocietyRegistration", Storage="_SocietyRegistrations", ThisKey="Id", OtherKey="StudentId")]
		public EntitySet<SocietyRegistration> SocietyRegistrations
		{
			get
			{
				return this._SocietyRegistrations;
			}
			set
			{
				this._SocietyRegistrations.Assign(value);
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUser_Club", Storage="_Clubs1", ThisKey="Id", OtherKey="AdminId")]
		public EntitySet<Club> Clubs1
		{
			get
			{
				return this._Clubs1;
			...
			set
			{
				this._Clubs1.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUser_ClubRegistration", Storage="_ClubRegistrations", ThisKey="Id", OtherKey="StudentId")]
		public EntitySet<ClubRegistration> ClubRegistrations
		{
			get
			{
				return this._ClubRegistrations;
			}
			set
			{
				this._ClubRegistrations.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUser_Society", Storage="_Societies1", ThisKey="Id", OtherKey="AdminId")]
		public EntitySet<Society> Societies1
		{
			get
			{
				return this._Societies1;
			}
			set
			{
				this._Societies1.Assign(value);
			}
		}
		...
		private void attach_SocietyRegistrations(SocietyRegistration entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUser = this;
		}
		
		private void detach_SocietyRegistrations(SocietyRegistration entity)
		{
			this.SendPropertyChanging();
		...
		private void attach_Clubs1(Club entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUser = this;
		}
		
		private void detach_Clubs1(Club entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUser = null;
		}
		
		private void attach_ClubRegistrations(ClubRegistration entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUser = this;
		}
		
		private void detach_ClubRegistrations(ClubRegistration entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUser = null;
		}
		
		private void attach_Societies1(Society entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUser = this;
		}
		
		private void detach_Societies1(Society entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUser = null;
		}
    ...
    partial void OnAdminIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PageKey", DbType="NVarChar(20)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AdminId", DbType="NVarChar(128)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Club_ClubRegistration", Storage="_ClubRegistrations", ThisKey="Id", OtherKey="ClubId")]
		public EntitySet<ClubRegistration> ClubRegistrations
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUser_Club", Storage="_AspNetUser", ThisKey="AdminId", OtherKey="Id", IsForeignKey=true)]
		public AspNetUser AspNetUser
		{
			get
			{
			...
			set
			{
							...
							|| (this._AspNetUser.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AspNetUser.Entity = null;
						previousValue.Clubs1.Remove(this);
					}
					this._AspNetUser.Entity = value;
					if ((value != null))
					{
						value.Clubs1.Add(this);
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ClubRegistration")]
	public partial class ClubRegistration : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnisActiveChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUser_ClubRegistration", Storage="_AspNetUser", ThisKey="StudentId", OtherKey="Id", IsForeignKey=true)]
		public AspNetUser AspNetUser
		{
			get
			{
			...
			set
			{
							...
							|| (this._AspNetUser.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AspNetUser.Entity = null;
						previousValue.ClubRegistrations.Remove(this);
					}
					this._AspNetUser.Entity = value;
					if ((value != null))
					{
						value.ClubRegistrations.Add(this);
						this._StudentId = value.Id;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Club_ClubRegistration", Storage="_Club", ThisKey="ClubId", OtherKey="Id", IsForeignKey=true)]
		public Club Club
		{
			get
			{
    ...
    partial void OnAdminIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Society_SocietyRegistration", Storage="_SocietyRegistrations", ThisKey="Id", OtherKey="SocietyId")]
		public EntitySet<SocietyRegistration> SocietyRegistrations
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUser_Society", Storage="_AspNetUser", ThisKey="AdminId", OtherKey="Id", IsForeignKey=true)]
		public AspNetUser AspNetUser
		{
			get
			{
			...
			set
			{
							...
							|| (this._AspNetUser.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AspNetUser.Entity = null;
						previousValue.Societies1.Remove(this);
					}
					this._AspNetUser.Entity = value;
					if ((value != null))
					{
						value.Societies1.Add(this);
						this._AdminId = value.Id;
					}
					else
					{
